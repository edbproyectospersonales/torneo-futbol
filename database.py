...
def cargar_datos_demo():
    ...
    goles_demo = [
        ("Martín García", 1, 1, 2), ("Lucas Pérez", 1, 1, 1), ("Diego Ruiz", 2, 1, 1),
        ("Sergio López", 4, 2, 2), ("Nicolás Torres", 4, 2, 2),
        ("Martín García", 1, 3, 1), ("Pablo Sosa", 5, 3, 1),
        ("Diego Ruiz", 2, 4, 2), ("Carlos Vega", 3, 4, 2),
        ("Sergio López", 4, 5, 3),
        ("Martín García", 1, 6, 2), ("Diego Ruiz", 2, 7, 1), ("Nicolás Torres", 4, 7, 1),
    ]
    for g in goles_demo:
        if g[3] > 0:
            cursor.execute(
